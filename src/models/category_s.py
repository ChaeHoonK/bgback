...
class Category(Table):
    ...
    def _ensure_table_sql(cls) -> str:
        return """
CREATE TABLE IF NOT EXISTS categories_s (
...
class CategoryClient(BaseClient):
    ...
    def get(self, category_uid):
        query = "SELECT * FROM categories_s WHERE category_uid = %s;"
    ...
    def delete(self, category_uid):
        query = "DELETE FROM categories_s WHERE category_uid = %s;"
